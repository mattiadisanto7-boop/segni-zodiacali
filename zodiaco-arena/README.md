...
- 9 modalità in singolo di livello avanzato:
  - **Indovina Chi**: elimina liberamente i dodici sospetti, richiedi indizi e formula l'accusa.
  - **Rivelazione**: appare un indizio alla volta; ogni errore sblocca il successivo e riduce i punti.
  - **Osservatorio**: identifica costellazioni animate partendo dalle sole stelle o attiva le linee perdendo punti.
  - **Ruota spezzata**: ricostruisci sequenze zodiacali senza risposte preconfezionate.
  - **Dossier astrale**: completa elemento, modalità, governatore e segno opposto.
  - **Archivio vero/falso**: seleziona tutte e sole le affermazioni vere.
  - **Codice zodiacale**: risolvi deduzioni che incrociano case, polarità, modalità, elementi e assi opposti.
...
- Le domande non si ripetono all'interno della stessa partita.
