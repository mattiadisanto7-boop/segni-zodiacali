# Pubblicare Zodiaco Arena 6.3 su GitHub e Render
...
```json
{"ok":true,"version":"6.3.0","roundSeconds":60,"progressiveRevealSeconds":30}
```

Inoltre, nella barra superiore del gioco deve comparire `v6.3.0`. Se uno dei due controlli mostra altro, Render sta ancora distribuendo un vecchio commit o una vecchia cache.
