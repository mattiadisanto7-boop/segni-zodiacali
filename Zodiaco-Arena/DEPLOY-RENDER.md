# Pubblicare Zodiaco Arena 6.0 su GitHub e Render
...
```json
{"ok":true,"version":"6.0.0","features":["guesswho-manuale","profilo-vivente","campionato-4-fasi","tessere-cpu-online"]}
```

Inoltre, nella barra superiore del gioco deve comparire `v6.0.0`. Se uno dei due controlli mostra altro, Render sta ancora distribuendo un vecchio commit o una vecchia cache.
